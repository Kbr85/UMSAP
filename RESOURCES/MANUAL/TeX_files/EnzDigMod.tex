...
\phantomsection
\num{1}. The text field Target Protein\label{par:tarportTargetProtein} allows users
...
\phantomsection
\num{2}. The text field Score Value\label{par:tarprotScoreValue} allows users to
