...
#------------------------------> Relevant paths
pCWD       = cwd            # Root of the folders containing UMSAP files
pResources = res            # Resources folder
...
fManual      = pResources / 'MANUAL/manual.pdf' # UMSAP Manual
...
# These need to be dict to match the values saved in the user conf file 
confVariableList = [
    'general',
]
...
#region -------------------------------------------------------------> METHODS
def ConfigLoad(file: Path) -> Literal[True]:
    ...
    try:
        ...
        dtscore.Notification(
            'errorU',
            msg        = "The configuration file could not be read.",
            tException = e,
        )
        return True
    #endregion ---------------------------------------------------------> Read 
...
def ConfigSave(file: Path) -> Literal[True]:
    ...
    data['modificationIgnore'] = modificationIgnore
    ...
    try:
        ...
        dtscore.Notification(
            'errorU',
            msg        = "The configuration file could not be saved.",
            tException = e,
        )
        pass
