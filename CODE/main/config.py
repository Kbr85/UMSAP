...
class Configuration():
    ...
    kwAbout:str    = 'MenuHelp About UMSAP'
    kwCheckUpd:str = 'MenuHelp Check for Updates'
    kwManual:str   = 'MenuHelp Manual'
    kwPref:str     = 'MenuHelp Preferences'
    kwTutorial:str = 'MenuHelp Tutorial'
