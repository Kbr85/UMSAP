...
class WinCorrA(gclasses.WinUtilUno):
    ...
    def __init__(self, parent=None, style=None):
     ...
     #--> Default values
        ...
        #     self.tcDataFile.SetValue("/Users/bravo/TEMP-GUI/BORRAR-GUI/PlayDATA/TARPROT/Mod-Enz-Dig-data-ms.txt")
        #     self.tcOutputFF.SetValue("/Users/bravo/TEMP-GUI/BORRAR-GUI/PlayDATA/TARPROT/Untitled.corr")
